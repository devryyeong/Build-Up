      ...
      <div className="x">
        <div className="main">
          ...
          <div className="main-signup">
            <Link to="/signup">
              <button className="yellow-btn">회원가입하러 가기</button>
            </Link>
          </div>
        </div>
        ...
        <div className="footer-area">
          <div className="footer-container">
            <img className="footer-img" src={require("../imgs/portfolio.png")} alt="포트폴리오" />
          ...
          <div className="footer-container">
            <img className="footer-img" src={require("../imgs/tree.png")} alt="나무" />
          ...
          <div className="footer-container">
            <img className="footer-img" src={require("../imgs/mt.png")} alt="건물" />
            <div className="footer-content">
